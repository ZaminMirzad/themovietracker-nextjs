  ...
  return (
    <main className="min-h-screen bg-light-background dark:bg-dark-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-red-500 to-pink-600 rounded-xl mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              >
                ...
                <span className="text-light-input-text dark:text-dark-input-text">{tech}</span>
              </motion.div>
            ))}
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="bg-light-input-background dark:bg-dark-input-background rounded-xl p-8 border border-light-border dark:border-dark-border">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="inline-flex items-center space-x-2 text-light-accent dark:text-dark-accent hover:opacity-80 transition-opacity font-medium"
              >
                <span>GitHub</span>
        ...
        >
          <div className="bg-gradient-to-r from-red-500 to-pink-600 rounded-xl p-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
              <Link
                href="/"
                className="inline-flex items-center justify-center bg-white text-red-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center bg-transparent border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-red-600 transition-all duration-200"
              >
