    ...
    <main className="min-h-screen bg-background dark:bg-dark-background">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-light-foreground dark:text-dark-foreground">Movie Details</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  {movie.revenue && movie.revenue > 0 && (
                    <div className="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                      <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Revenue</span>
                      <span className="font-semibold text-gray-900 dark:text-white">
            ...
            {trailers && trailers.length > 0 && (
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <h2 className="text-2xl font-bold text-foreground dark:text-dark-foreground">Trailer</h2>
                    ...
                    <div className="relative w-full h-full">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-8">
                        <div className="max-w-2xl">
                          <h3 className="text-2xl font-bold text-white mb-3">Watch the Trailer</h3>
                          <p className="text-gray-200 text-lg leading-relaxed line-clamp-2">
                            {movie.overview || 'Experience the magic of this incredible film.'}
                          </p>
                        </div>
                      </div>
                ...
                {trailers.length > 1 && (
                  <div className="space-y-4">
                    <h4 className="text-lg font-semibold text-foreground dark:text-dark-foreground">More Trailers</h4>
        ...
        {cast && cast.length > 0 && (
          <div className="mb-16">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl font-bold text-foreground dark:text-dark-foreground">Cast</h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-6">
              {filterCastWithProfileImages(cast).slice(0, 16).map((actor) => (
                <div 
                  key={actor.id} 
        ...
        {relatedMovies && relatedMovies.length > 0 && (
          <div className="mb-16">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl font-bold text-foreground dark:text-dark-foreground">You May Also Like</h2>
              <div className="flex items-center gap-2 text-sm text-muted-foreground dark:text-dark-muted-foreground">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
              {filterAndLimitMedia(relatedMovies).slice(0, 6).map((relatedMovie) => (
                <div
                  key={relatedMovie.id}
        ...
        {crew && crew.length > 0 && (
          <div className="mb-16">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl font-bold text-foreground dark:text-dark-foreground">Crew</h2>
              <span className="text-sm text-muted-foreground dark:text-dark-muted-foreground bg-muted dark:bg-dark-muted px-3 py-1 rounded-full">
                {crew.length} members
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-6">
              {filterCastWithProfileImages(crew).slice(0, 16).map((member) => (
                <div 
        ...
        {movie?.production_companies && movie.production_companies.length > 0 && (
          <div className="mb-16">
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl font-bold text-foreground dark:text-dark-foreground">Production Companies</h2>
              <span className="text-sm text-muted-foreground dark:text-dark-muted-foreground bg-muted dark:bg-dark-muted px-3 py-1 rounded-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {movie.production_companies.map((company) => (
                <div key={company.id} className="group bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-gray-700">
            <div className="p-8">
              <div className="flex justify-between items-start mb-8">
                <div>
                  <h2 className="text-3xl font-bold text-foreground dark:text-dark-foreground mb-2">{selectedCast.name}</h2>
                  <div className="flex items-center gap-2 text-sm text-muted-foreground dark:text-dark-muted-foreground">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
              ...
              <div className="flex gap-8">
                ...
                <div className="flex-1 space-y-6">
                  <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-6 rounded-2xl">
                    <h3 className="text-lg font-semibold mb-3 text-foreground dark:text-dark-foreground">Character</h3>
                    <p className="text-gray-700 dark:text-gray-300 text-lg">{selectedCast.character}</p>
                  </div>

                  {selectedCast.biography && (
                    <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-6 rounded-2xl">
                      <h3 className="text-lg font-semibold mb-3 text-foreground dark:text-dark-foreground">Biography</h3>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    {selectedCast.birthday && (
                      <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 rounded-xl">
                        <span className="text-sm text-muted-foreground dark:text-dark-muted-foreground block mb-1">Birthday</span>
                        <p className="font-semibold text-foreground dark:text-dark-foreground">{selectedCast.birthday}</p>
                      </div>
                    )}
                    {selectedCast.place_of_birth && (
                      <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 rounded-xl">
                        <span className="text-sm text-muted-foreground dark:text-dark-muted-foreground block mb-1">Birth Place</span>
                        <p className="font-semibold text-foreground dark:text-dark-foreground">{selectedCast.place_of_birth}</p>
                      </div>
                    )}
                    {selectedCast.known_for_department && (
                      <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 rounded-xl">
                        <span className="text-sm text-muted-foreground dark:text-dark-muted-foreground block mb-1">Known For</span>
                        <p className="font-semibold text-foreground dark:text-dark-foreground">{selectedCast.known_for_department}</p>
                      </div>
                    )}
                    {selectedCast.popularity && (
                      <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 rounded-xl">
                        <span className="text-sm text-muted-foreground dark:text-dark-muted-foreground block mb-1">Popularity</span>
                        <p className="font-semibold text-foreground dark:text-dark-foreground">{selectedCast.popularity.toFixed(1)}</p>
                      </div>
                    )}
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-gray-700">
            <div className="p-8">
              <div className="flex justify-between items-start mb-8">
                <div>
                  <h2 className="text-3xl font-bold text-foreground dark:text-dark-foreground mb-2">{selectedCrew.name}</h2>
                  <div className="flex items-center gap-2 text-sm text-muted-foreground dark:text-dark-muted-foreground">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                    </svg>
              ...
              <div className="flex gap-8">
                ...
                <div className="flex-1 space-y-6">
                  <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-6 rounded-2xl">
                    <h3 className="text-lg font-semibold mb-3 text-foreground dark:text-dark-foreground">Job</h3>
                    <p className="text-gray-700 dark:text-gray-300 text-lg">{selectedCrew.job}</p>
                  </div>

                  <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-6 rounded-2xl">
                    <h3 className="text-lg font-semibold mb-3 text-foreground dark:text-dark-foreground">Department</h3>
                    <p className="text-gray-700 dark:text-gray-300 text-lg">{selectedCrew.department}</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    {selectedCrew.birthday && (
                      <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 rounded-xl">
                        <span className="text-sm text-muted-foreground dark:text-dark-muted-foreground block mb-1">Birthday</span>
                        <p className="font-semibold text-foreground dark:text-dark-foreground">{selectedCrew.birthday}</p>
                      </div>
                    )}
                    {selectedCrew.place_of_birth && (
                      <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 rounded-xl">
                        <span className="text-sm text-muted-foreground dark:text-dark-muted-foreground block mb-1">Birth Place</span>
                        <p className="font-semibold text-foreground dark:text-dark-foreground">{selectedCrew.place_of_birth}</p>
                      </div>
                    )}
                    {selectedCrew.known_for_department && (
                      <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 rounded-xl">
                        <span className="text-sm text-muted-foreground dark:text-dark-muted-foreground block mb-1">Known For</span>
                        <p className="font-semibold text-foreground dark:text-dark-foreground">{selectedCrew.known_for_department}</p>
                      </div>
                    )}
                    {selectedCrew.popularity && (
                      <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 rounded-xl">
                        <span className="text-sm text-muted-foreground dark:text-dark-muted-foreground block mb-1">Popularity</span>
                        <p className="font-semibold text-foreground dark:text-dark-foreground">{selectedCrew.popularity.toFixed(1)}</p>
                      </div>
                    )}
                  </div>
                </div>
